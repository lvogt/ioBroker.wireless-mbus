...
import type { DataRecordHeadersCacheEntry } from 'wireless-mbus-parser';
 ...
 *
 * @param layout
 * @returns whether the parser can be given the entry
 */
function isValidLayout(layout: unknown): boolean {
    const entry = layout as Partial<DataRecordHeadersCacheEntry>;
