...
class SerialDevice {
    constructor(options, mode, onMessage, onError, loggerFunction) {
        ...
        // The unit tests emulate a device by handing in a SerialPortStream
        // subclass here. It is kept out of the options passed to the port
        // itself, which only knows about path, baudRate and the like.
        const { serialPortImpl, ...portOptions } = options ?? {};
