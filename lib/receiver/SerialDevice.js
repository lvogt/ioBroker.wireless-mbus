 ...
 *
 * @typedef {object} ResponseReader
 * @property {(response: Buffer) => boolean} accepts whether this message is the answer the command is waiting for
 * @property {(response: Buffer) => void} deliver hands the answer to the command
 */
...
class SerialDevice {
     ...
     *
     * @param {(response: Buffer) => boolean} [isExpectedResponse] which
     ...
     *
     * @param {string|number} command the command, in the form the receiver builds its packages from
     * @param {Buffer|string} [payload] what to send with it
     * @param {(response: Buffer) => boolean} [isExpectedResponse] see readResponse()
     * @returns the answer to the command
     */
