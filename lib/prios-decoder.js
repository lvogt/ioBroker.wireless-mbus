// @ts-nocheck - superseded by the wireless-mbus-parser library (which handles
// the DME/PRIOS CI codes); scheduled for removal. The LFSR below XORs booleans,
// which is valid JS (they coerce to 0/1) but not expressible for tsc.
